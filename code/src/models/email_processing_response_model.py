...
class EmailProcessingResponse:
    def __init__(self, request_type: str, extracted_fields: Dict[str, Any], confidence_score: float):
        """
    ...
    def __repr__(self):
        fields_str = json.dumps(self.extracted_fields, indent=2)  # Pretty-print JSON fields
        return (
