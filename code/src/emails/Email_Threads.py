    ...
    "Thread5": [
        ...
        Email(
            ...
            body=(
                ...
                "A payment of $800 was made via ACH on March 22, 2025, but has not yet been reflected. "
                "Could you confirm the status and update my account accordingly? "
                "I have attached supporting documents for your reference. Please let me know if further details are required. "
                "Best regards, "
                "[Customer Name]"
            ),
            email_id="107",
            attachments=["adjustment_proof.pdf", "payment_receipt.pdf"],
            thread_id="1014",
            sender_role="customer",
        ),
        Email(
